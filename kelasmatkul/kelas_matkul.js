        ...
        $.ajax({
            ...
            success: function (response) {
                if(response === 'duplicate') {
                    showNotification('Kombinasi ID Kelas dan ID Matkul sudah ada', 'danger');
                } else {
                    $('#addKelasMatkulModal').modal('hide');
                    loadData();
                    showNotification('Kelas Matkul berhasil ditambah', 'success');
                }
            }
        });
    });
        ...
        $.ajax({
            ...
            success: function (response) {
                if(response === 'duplicate') {
                    ...
                    loadData();
                    showNotification('Kelas Matkul berhasil diupdate', 'success');
                }
            }
        });
    });
